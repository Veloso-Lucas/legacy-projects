...
import com.lvb.challenge.picpay.PicpayBackendChallenge.service.kafka.producer.email.EmailTopicProducer;
...
public class AccountService {
    ...
    public void sendValidationCode(final long accountId, final ValidationType validationType) throws MessagingException, IOException {
        ...
        if (validationType == ValidationType.EMAIL)
            emailTopicProducer.send(objectWriter.writeValueAsString(account));
