package com.lvb.challenge.picpay.PicpayBackendChallengeNotification.service.email;
...
public class EmailService {
    ...
    public void sendEmailCode(final AccountBaseDTO accountBase, final long code) throws MessagingException, IOException {
